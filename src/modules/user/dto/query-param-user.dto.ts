...
export class UserQueryParamDto implements ISearchQuery {
  @ApiProperty({
    type: String,
    description: 'Search key for email, lastName or firstName',
    example: 'join',
    required: false,
  })
  search?: string;
  ...
  constructor(partial: Partial<UserQueryParamDto>) {
